...
**VERSION 1 - SITE WEB (DÉTAILLÉE & COLORÉE):**
Utilise des balises HTML (h3, h4, ul, strong) pour structurer.
<h3>📌 PARTIE INTRODUCTIVE (15 min)</h3>
<h4>🔹 Prise en main (3 min)</h4>
<ul><li>Appel, contrôle tenues, présentation objectif</li></ul>
<h4>🔹 Échauffement (12 min)</h4>
<ul><li>Général: Course, activation articulaire</li><li>Spécifique: [Exercices lien avec ${apsFinale}]</li></ul>

<h3>⚡ PARTIE FONDAMENTALE (35 min)</h3>
Pour chaque situation d'apprentissage (hors référence):
<h4>🎯 SITUATION [N] (Temps)</h4>
<p><strong>But:</strong> [Intention]</p>
<p><strong>Déroulement:</strong> [Organisation]</p>
<p><strong>Consignes:</strong> [Règles importantes]</p>
<p><strong>Variantes:</strong> [Simplifier/Complexifier]</p>
<p><strong>🔵 Critères réalisation:</strong> [Gestes clés]</p>
<p><strong>🟢 Critères réussite:</strong> [Indicateurs de fin]</p>

<h4>🏆 SITUATION DE RÉFÉRENCE (Match/Perf)</h4>
<p>[Description rapide]</p>

<h3>🧘 PARTIE FINALE (10 min)</h3>
<p>Retour au calme, bilan, hygiène</p>

===SEPARATEUR===

**VERSION 2 - DOC WORD / PDF (CONTENU SPÉCIFIQUE):**
Génère ce contenu au format TEXTE STRUCTURÉ (pas de HTML).

**PARTIE INTRODUCTIVE (Résumé):**
[Résumé concis: Prise en main + Échauffement global/spécifique. 2-3 lignes max]

**PARTIE FONDAMENTALE (Détaillée sauf Réf):**
SITUATION 1:
- Déroulement: [Description]
- Variantes: [ + / - ]
- Consignes: [Liste]
- Critères RÉALISATION: [Liste]
- Critères RÉUSSITE: [Liste]
...
SITUATION RÉFÉRENCE:
[Nom/Type seulement, ex: Match 7c7 évalué]

**PARTIE FINALE (Résumé):**
[Résumé concis: Bilan, retour au calme. 1-2 lignes]
