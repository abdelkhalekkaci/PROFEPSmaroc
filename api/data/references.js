...
const CRITERES_OBS = {
    ...
    'Course en durée': { criteres: [{ nom: 'Continuité', sous: ['Sans arrêt', 'Avec marche'] }, { nom: 'Respiration', sous: ['Aisée', 'Haletante'] }, { nom: 'Allure', sous: ['Stable', 'Variable'] }, { nom: 'Arrivée', sous: ['En course', 'En marchant'] }] },
