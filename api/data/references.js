...
const SCHEMAS = {
    ...
    'Handball': {
        1: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                <!-- Terrain -->
                <rect x="20" y="20" width="300" height="160" fill="#4CAF50" stroke="#2E7D32" stroke-width="3" rx="5"/>
                
                <!-- Lignes terrain -->
                <line x1="170" y1="20" x2="170" y2="180" stroke="#fff" stroke-width="2" stroke-dasharray="8,4" opacity="0.6"/>
                
                <!-- Zone gardien gauche -->
                <path d="M 20 70 Q 60 100 20 130" fill="none" stroke="#fff" stroke-width="3"/>
                <rect x="20" y="75" width="8" height="50" fill="#E9C46A" opacity="0.8"/>
                
                <!-- Zone gardien droite -->
                <path d="M 320 70 Q 280 100 320 130" fill="none" stroke="#fff" stroke-width="3"/>
                <rect x="312" y="75" width="8" height="50" fill="#E9C46A" opacity="0.8"/>
                
                <!-- But droit (cible) -->
                <rect x="312" y="80" width="8" height="40" fill="#1D3557" stroke="#0D1B2A" stroke-width="2"/>
                ...
                <line x1="100" y1="15" x2="240" y2="15" stroke="#457B9D" stroke-width="3" marker-end="url(#arrowhead1)"/>
                <text x="170" y="12" text-anchor="middle" fill="#457B9D" font-size="10" font-weight="bold">SENS DU JEU →</text>
                
                <!-- Attaquants (rouge) -->
                <circle cx="80" cy="60" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="80" y="65" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">A1</text>
                
                <circle cx="80" cy="140" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="80" y="145" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">A2</text>
                
                <circle cx="130" cy="85" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="130" y="90" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">A3</text>
                
                <circle cx="130" cy="115" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="130" y="120" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">A4</text>
                
                <!-- Ballon -->
                <circle cx="80" cy="60" r="6" fill="#F4A261" stroke="#E76F51" stroke-width="2"/>
                
                <!-- Défenseurs (bleu) -->
                <circle cx="220" cy="80" r="14" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <text x="220" y="85" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">D1</text>
                
                <circle cx="220" cy="120" r="14" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <text x="220" y="125" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">D2</text>
                
                <!-- Gardien -->
                <circle cx="295" cy="100" r="12" fill="#2A9D8F" stroke="#fff" stroke-width="2"/>
                <text x="295" y="105" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">G</text>
                
                <!-- Trajectoires de passe possibles -->
                <path d="M 94 60 Q 112 72 116 85" stroke="#457B9D" stroke-width="2" stroke-dasharray="6,3" fill="none" marker-end="url(#arrowhead1)"/>
                <path d="M 94 140 Q 112 128 116 115" stroke="#457B9D" stroke-width="2" stroke-dasharray="6,3" fill="none" marker-end="url(#arrowhead1)"/>
                
                <!-- Zone d'action -->
                <ellipse cx="180" cy="100" rx="50" ry="40" fill="#E63946" opacity="0.15" stroke="#E63946" stroke-width="1" stroke-dasharray="4,2"/>
                <text x="180" y="100" text-anchor="middle" fill="#E63946" font-size="8" font-weight="bold">ZONE D'ATTAQUE</text>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:20px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#E63946;border-radius:50%;display:inline-block;"></span> Attaquants (A1-A4)
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#1D3557;border-radius:50%;display:inline-block;"></span> Défenseurs (D1-D2)
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#2A9D8F;border-radius:50%;display:inline-block;"></span> Gardien
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#F4A261;border-radius:50%;display:inline-block;"></span> Ballon
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:20px;height:3px;background:#457B9D;display:inline-block;"></span> Passes
                </span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation 4 vs 2 + Gardien | Terrain 25×15m | Objectif : Progression collective</p>
        </div>`,
        ...
        2: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <!-- Ligne médiane -->
                <line x1="170" y1="20" x2="170" y2="180" stroke="#fff" stroke-width="3"/>
                <circle cx="170" cy="100" r="20" fill="none" stroke="#fff" stroke-width="2"/>
                
                <!-- Zones gardien -->
                <path d="M 20 70 Q 55 100 20 130" fill="rgba(255,255,255,0.2)" stroke="#fff" stroke-width="2"/>
                <path d="M 320 70 Q 285 100 320 130" fill="rgba(255,255,255,0.2)" stroke="#fff" stroke-width="2"/>
                
                <!-- Buts -->
                <rect x="20" y="80" width="6" height="40" fill="#E9C46A" stroke="#333" stroke-width="1"/>
                <rect x="314" y="80" width="6" height="40" fill="#E9C46A" stroke="#333" stroke-width="1"/>
                
                <!-- Équipe Rouge (gauche) -->
                <circle cx="45" cy="100" r="11" fill="#2A9D8F" stroke="#fff" stroke-width="2"/>
                <text x="45" y="104" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">G</text>
                
                <circle cx="75" cy="55" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="75" cy="100" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="75" cy="145" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="110" cy="75" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="110" cy="125" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                
                <!-- Équipe Bleue (droite) -->
                <circle cx="295" cy="100" r="11" fill="#2A9D8F" stroke="#fff" stroke-width="2"/>
                <text x="295" y="104" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">G</text>
                
                <circle cx="265" cy="55" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="265" cy="100" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="265" cy="145" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="230" cy="75" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="230" cy="125" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                
                <!-- Ballon au centre -->
                <circle cx="170" cy="100" r="7" fill="#F4A261" stroke="#E76F51" stroke-width="2"/>
                
                <!-- Zones tactiques -->
                <rect x="20" y="20" width="75" height="160" fill="#E63946" opacity="0.1"/>
                <text x="57" y="190" text-anchor="middle" fill="#E63946" font-size="9" font-weight="bold">DÉFENSE</text>
                
                <rect x="95" y="20" width="75" height="160" fill="#F4A261" opacity="0.1"/>
                <text x="132" y="190" text-anchor="middle" fill="#F4A261" font-size="9" font-weight="bold">MILIEU</text>
                
                <rect x="170" y="20" width="75" height="160" fill="#F4A261" opacity="0.1"/>
                <text x="207" y="190" text-anchor="middle" fill="#F4A261" font-size="9" font-weight="bold">MILIEU</text>
                
                <rect x="245" y="20" width="75" height="160" fill="#1D3557" opacity="0.1"/>
                <text x="282" y="190" text-anchor="middle" fill="#1D3557" font-size="9" font-weight="bold">ATTAQUE</text>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:20px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#E63946;border-radius:50%;display:inline-block;"></span> Équipe A (5 joueurs)
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#1D3557;border-radius:50%;display:inline-block;"></span> Équipe B (5 joueurs)
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#2A9D8F;border-radius:50%;display:inline-block;"></span> Gardiens
                </span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Match 5 vs 5 + Gardiens | Terrain 30×20m | Application des règles officielles</p>
        </div>`,
        
        3: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                <!-- Terrain complet -->
                <rect x="20" y="20" width="300" height="160" fill="#4CAF50" stroke="#2E7D32" stroke-width="3" rx="5"/>
                ...
                <!-- Ligne médiane -->
                <line x1="170" y1="20" x2="170" y2="180" stroke="#fff" stroke-width="3"/>
                <circle cx="170" cy="100" r="25" fill="none" stroke="#fff" stroke-width="2"/>
                
                <!-- Zone 6m gauche -->
                <path d="M 20 60 Q 70 100 20 140" fill="rgba(233,196,106,0.3)" stroke="#fff" stroke-width="3"/>
                <text x="45" y="100" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">6m</text>
                
                <!-- Zone 6m droite -->
                <path d="M 320 60 Q 270 100 320 140" fill="rgba(233,196,106,0.3)" stroke="#fff" stroke-width="3"/>
                <text x="295" y="100" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">6m</text>
                
                <!-- Zone 9m (pointillés) -->
                <path d="M 20 45 Q 90 100 20 155" fill="none" stroke="#fff" stroke-width="2" stroke-dasharray="8,4"/>
                <path d="M 320 45 Q 250 100 320 155" fill="none" stroke="#fff" stroke-width="2" stroke-dasharray="8,4"/>
                
                <!-- Buts -->
                <rect x="20" y="78" width="8" height="44" fill="#E9C46A" stroke="#333" stroke-width="2"/>
                <rect x="312" y="78" width="8" height="44" fill="#E9C46A" stroke="#333" stroke-width="2"/>
                
                <!-- Postes indiqués -->
                <text x="55" y="45" fill="#fff" font-size="8" font-weight="bold">Ailier G</text>
                <text x="55" y="160" fill="#fff" font-size="8" font-weight="bold">Ailier D</text>
                <text x="85" y="75" fill="#fff" font-size="8" font-weight="bold">Arrière G</text>
                <text x="85" y="130" fill="#fff" font-size="8" font-weight="bold">Arrière D</text>
                <text x="100" y="102" fill="#fff" font-size="8" font-weight="bold">DC</text>
                <text x="65" y="102" fill="#fff" font-size="8" font-weight="bold">Pivot</text>
                
                <!-- Indicateur situation de référence -->
                <rect x="120" y="185" width="100" height="25" fill="#E63946" rx="5"/>
                <text x="170" y="202" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">MATCH OFFICIEL</text>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:15px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="font-size:12px;">📍 Zone 6m (interdite)</span>
                <span style="font-size:12px;">⚪ Zone 9m (tir)</span>
                <span style="font-size:12px;">🥅 Buts (3m × 2m)</span>
                <span style="font-size:12px;">⏱️ 2×10 min</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation de référence | Match 6 vs 6 | Terrain 40×20m | Règles officielles adaptées</p>
        </div>`
    },
    ...
    'Football': {
        1: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <!-- Lignes -->
                <line x1="170" y1="20" x2="170" y2="180" stroke="#fff" stroke-width="2" stroke-dasharray="8,4" opacity="0.5"/>
                
                <!-- Surfaces de réparation -->
                <rect x="20" y="55" width="40" height="70" fill="none" stroke="#fff" stroke-width="2"/>
                <rect x="280" y="55" width="40" height="70" fill="none" stroke="#fff" stroke-width="2"/>
                
                <!-- Buts -->
                <rect x="20" y="75" width="5" height="30" fill="#E9C46A" stroke="#333" stroke-width="1"/>
                <rect x="315" y="75" width="5" height="30" fill="#E9C46A" stroke="#333" stroke-width="1"/>
                
                <!-- Sens du jeu -->
                <defs>
                    <marker id="arrowF1" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
                        <polygon points="0 0, 10 3.5, 0 7" fill="#457B9D"/>
                    </marker>
                </defs>
                <line x1="100" y1="12" x2="240" y2="12" stroke="#457B9D" stroke-width="3" marker-end="url(#arrowF1)"/>
                <text x="170" y="10" text-anchor="middle" fill="#457B9D" font-size="10" font-weight="bold">SENS DU JEU →</text>
                
                <!-- Attaquants -->
                <circle cx="90" cy="55" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="90" y="60" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">A1</text>
                
                <circle cx="90" cy="125" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="90" y="130" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">A2</text>
                
                <circle cx="130" cy="75" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="130" y="80" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">A3</text>
                
                <circle cx="130" cy="105" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="130" y="110" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">A4</text>
                
                <!-- Ballon avec A1 -->
                <circle cx="102" cy="50" r="6" fill="#F4A261" stroke="#E76F51" stroke-width="2"/>
                
                <!-- Défenseurs -->
                <circle cx="220" cy="80" r="14" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <text x="220" y="85" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">D1</text>
                
                <circle cx="220" cy="120" r="14" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <text x="220" y="125" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">D2</text>
                
                <!-- Trajectoires -->
                <path d="M 104 55 L 116 75" stroke="#457B9D" stroke-width="2" stroke-dasharray="6,3" fill="none" marker-end="url(#arrowF1)"/>
                <path d="M 144 75 L 200 80" stroke="#E63946" stroke-width="2" stroke-dasharray="4,2" fill="none" opacity="0.5"/>
                <text x="175" y="72" fill="#E63946" font-size="8">tir?</text>
                
                <!-- Zone de progression -->
                <rect x="160" y="50" width="80" height="80" fill="#E63946" opacity="0.1" stroke="#E63946" stroke-dasharray="4,2"/>
                <text x="200" y="95" text-anchor="middle" fill="#E63946" font-size="9" font-weight="bold">ZONE CIBLE</text>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:20px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#E63946;border-radius:50%;"></span> Attaquants
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#1D3557;border-radius:50%;"></span> Défenseurs
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#F4A261;border-radius:50%;"></span> Ballon
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:20px;border-top:2px dashed #457B9D;"></span> Passes
                </span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation 4 vs 2 | Terrain 25×20m | Conservation et progression</p>
        </div>`,
        ...
        2: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <line x1="170" y1="20" x2="170" y2="180" stroke="#fff" stroke-width="2"/>
                <circle cx="170" cy="100" r="25" fill="none" stroke="#fff" stroke-width="2"/>
                <circle cx="170" cy="100" r="3" fill="#fff"/>
                
                <!-- Surfaces -->
                <rect x="20" y="50" width="45" height="80" fill="none" stroke="#fff" stroke-width="2"/>
                <rect x="275" y="50" width="45" height="80" fill="none" stroke="#fff" stroke-width="2"/>
                
                <!-- Petites surfaces -->
                <rect x="20" y="70" width="20" height="40" fill="none" stroke="#fff" stroke-width="2"/>
                <rect x="300" y="70" width="20" height="40" fill="none" stroke="#fff" stroke-width="2"/>
                
                <!-- Buts -->
                <rect x="20" y="80" width="5" height="20" fill="#E9C46A" stroke="#333" stroke-width="1"/>
                <rect x="315" y="80" width="5" height="20" fill="#E9C46A" stroke="#333" stroke-width="1"/>
                
                <!-- Équipe Rouge -->
                <circle cx="40" cy="90" r="10" fill="#2A9D8F" stroke="#fff" stroke-width="2"/>
                <text x="40" y="94" text-anchor="middle" fill="#fff" font-size="8" font-weight="bold">G</text>
                
                <circle cx="70" cy="50" r="10" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="70" cy="130" r="10" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="100" cy="70" r="10" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="100" cy="110" r="10" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="140" cy="90" r="10" fill="#E63946" stroke="#fff" stroke-width="2"/>
                
                <!-- Équipe Bleue -->
                <circle cx="300" cy="90" r="10" fill="#2A9D8F" stroke="#fff" stroke-width="2"/>
                <text x="300" y="94" text-anchor="middle" fill="#fff" font-size="8" font-weight="bold">G</text>
                
                <circle cx="270" cy="50" r="10" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="270" cy="130" r="10" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="240" cy="70" r="10" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="240" cy="110" r="10" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="200" cy="90" r="10" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                
                <!-- Ballon -->
                <circle cx="170" cy="100" r="6" fill="#F4A261" stroke="#E76F51" stroke-width="2"/>
                
                <!-- Indication thème -->
                <rect x="125" y="185" width="90" height="22" fill="#457B9D" rx="4"/>
                <text x="170" y="200" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">MATCH À THÈME</text>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:20px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#E63946;border-radius:50%;"></span> Équipe A
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#1D3557;border-radius:50%;"></span> Équipe B
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#2A9D8F;border-radius:50%;"></span> Gardiens
                </span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Match 5 vs 5 + Gardiens | Terrain 40×25m | Appliquer l'objectif travaillé</p>
        </div>`,
        ...
        3: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <!-- Ligne médiane -->
                <line x1="170" y1="20" x2="170" y2="180" stroke="#fff" stroke-width="3"/>
                <circle cx="170" cy="100" r="30" fill="none" stroke="#fff" stroke-width="2"/>
                <circle cx="170" cy="100" r="4" fill="#fff"/>
                
                <!-- Surfaces de réparation -->
                <rect x="20" y="45" width="55" height="90" fill="none" stroke="#fff" stroke-width="2"/>
                <rect x="265" y="45" width="55" height="90" fill="none" stroke="#fff" stroke-width="2"/>
                
                <!-- Petites surfaces -->
                <rect x="20" y="65" width="25" height="50" fill="none" stroke="#fff" stroke-width="2"/>
                <rect x="295" y="65" width="25" height="50" fill="none" stroke="#fff" stroke-width="2"/>
                
                <!-- Points de penalty -->
                <circle cx="55" cy="90" r="2" fill="#fff"/>
                <circle cx="285" cy="90" r="2" fill="#fff"/>
                
                <!-- Buts -->
                <rect x="20" y="77" width="6" height="26" fill="#E9C46A" stroke="#333" stroke-width="2"/>
                <rect x="314" y="77" width="6" height="26" fill="#E9C46A" stroke="#333" stroke-width="2"/>
                
                <!-- Coins -->
                <path d="M 20 20 Q 20 25 25 25" fill="none" stroke="#fff" stroke-width="2"/>
                <path d="M 320 20 Q 320 25 315 25" fill="none" stroke="#fff" stroke-width="2"/>
                <path d="M 20 180 Q 20 175 25 175" fill="none" stroke="#fff" stroke-width="2"/>
                <path d="M 320 180 Q 320 175 315 175" fill="none" stroke="#fff" stroke-width="2"/>
                
                <!-- Indication match officiel -->
                <rect x="115" y="185" width="110" height="25" fill="#E63946" rx="5"/>
                <text x="170" y="202" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">MATCH OFFICIEL</text>
                
                <!-- Postes -->
                <text x="40" y="95" fill="#fff" font-size="8" font-weight="bold">GB</text>
                <text x="85" y="50" fill="#fff" font-size="7">DC</text>
                <text x="85" y="140" fill="#fff" font-size="7">DC</text>
                <text x="115" y="95" fill="#fff" font-size="7">MIL</text>
                <text x="145" y="60" fill="#fff" font-size="7">ATT</text>
                <text x="145" y="130" fill="#fff" font-size="7">ATT</text>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:15px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="font-size:12px;">📐 Terrain 50×30m</span>
                <span style="font-size:12px;">🥅 Buts réglementaires</span>
                <span style="font-size:12px;">⏱️ 2×8 min</span>
                <span style="font-size:12px;">👨‍⚖️ Arbitrage élèves</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation de référence | Match 7 vs 7 | Règles officielles adaptées</p>
        </div>`
    },
    ...
    'Basketball': {
        1: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                <!-- Terrain (parquet) -->
                <rect x="20" y="20" width="300" height="160" fill="#DEB887" stroke="#8B4513" stroke-width="3" rx="5"/>
                
                <!-- Lignes de parquet -->
                <line x1="80" y1="20" x2="80" y2="180" stroke="#CD853F" stroke-width="1" opacity="0.4"/>
                <line x1="140" y1="20" x2="140" y2="180" stroke="#CD853F" stroke-width="1" opacity="0.4"/>
                <line x1="200" y1="20" x2="200" y2="180" stroke="#CD853F" stroke-width="1" opacity="0.4"/>
                <line x1="260" y1="20" x2="260" y2="180" stroke="#CD853F" stroke-width="1" opacity="0.4"/>
                
                <!-- Raquette et panier -->
                <rect x="265" y="55" width="55" height="70" fill="none" stroke="#1D3557" stroke-width="3"/>
                <circle cx="292" cy="90" r="25" fill="none" stroke="#1D3557" stroke-width="2"/>
                <rect x="305" y="82" width="15" height="16" fill="#E9C46A" stroke="#333" stroke-width="2"/>
                <circle cx="312" cy="90" r="8" fill="none" stroke="#E63946" stroke-width="3"/>
                
                <!-- Ligne 3 points -->
                <path d="M 265 35 Q 220 90 265 145" fill="none" stroke="#1D3557" stroke-width="2"/>
                
                <!-- Sens du jeu -->
                <defs>
                    <marker id="arrowB1" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
                        <polygon points="0 0, 10 3.5, 0 7" fill="#457B9D"/>
                    </marker>
                </defs>
                <line x1="80" y1="12" x2="220" y2="12" stroke="#457B9D" stroke-width="3" marker-end="url(#arrowB1)"/>
                <text x="150" y="10" text-anchor="middle" fill="#457B9D" font-size="10" font-weight="bold">SENS DU JEU →</text>
                
                <!-- Attaquants -->
                <circle cx="100" cy="55" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="100" y="60" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">A1</text>
                
                <circle cx="100" cy="125" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="100" y="130" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">A2</text>
                
                <circle cx="150" cy="90" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="150" y="95" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">A3</text>
                
                <!-- Ballon -->
                <circle cx="100" cy="43" r="7" fill="#F4A261" stroke="#E76F51" stroke-width="2"/>
                
                <!-- Défenseurs -->
                <circle cx="210" cy="75" r="14" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <text x="210" y="80" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">D1</text>
                
                <circle cx="210" cy="110" r="14" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <text x="210" y="115" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">D2</text>
                
                <!-- Trajectoire passe et va -->
                <path d="M 114 55 L 136 90" stroke="#457B9D" stroke-width="2" stroke-dasharray="6,3" fill="none" marker-end="url(#arrowB1)"/>
                <path d="M 114 55 Q 180 40 270 75" stroke="#E63946" stroke-width="2" stroke-dasharray="4,2" fill="none" opacity="0.6"/>
                <text x="190" y="50" fill="#E63946" font-size="9" font-weight="bold">Coupe panier</text>
                
                <!-- Zone lay-up -->
                <ellipse cx="290" cy="90" rx="25" ry="35" fill="#E63946" opacity="0.15" stroke="#E63946" stroke-dasharray="4,2"/>
            </svg>
            ...
            <div style="display:flex;justify-content:center;gap:20px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                ...
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:20px;border-top:2px dashed #457B9D;"></span> Passe
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:20px;border-top:2px dashed #E63946;"></span> Déplacement
                </span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation 3 vs 2 | Demi-terrain | Passe et va vers le panier</p>
        </div>`,
        ...
        2: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <!-- Raquette -->
                <rect x="265" y="50" width="55" height="80" fill="none" stroke="#1D3557" stroke-width="3"/>
                <circle cx="292" cy="90" r="30" fill="none" stroke="#1D3557" stroke-width="2"/>
                
                <!-- Panier -->
                <rect x="305" y="80" width="15" height="20" fill="#E9C46A" stroke="#333" stroke-width="2"/>
                <circle cx="312" cy="90" r="10" fill="none" stroke="#E63946" stroke-width="3"/>
                
                <!-- Ligne 3 points -->
                <path d="M 265 30 Q 200 90 265 150" fill="none" stroke="#1D3557" stroke-width="2"/>
                
                <!-- Équipe Rouge -->
                <circle cx="80" cy="50" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="80" cy="130" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="130" cy="70" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="130" cy="110" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                
                <!-- Équipe Bleue -->
                <circle cx="200" cy="50" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="200" cy="130" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="240" cy="70" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="240" cy="110" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                
                <!-- Ballon -->
                <circle cx="130" cy="90" r="7" fill="#F4A261" stroke="#E76F51" stroke-width="2"/>
            ...
            <div style="display:flex;justify-content:center;gap:20px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                ...
                <span style="font-size:12px;">🏀 Bonus passe et va = +1pt</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Match 4 vs 4 | Demi-terrain | Application du passe et va</p>
        </div>`,
        ...
        3: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <!-- Ligne médiane -->
                <line x1="170" y1="20" x2="170" y2="180" stroke="#1D3557" stroke-width="3"/>
                <circle cx="170" cy="100" r="25" fill="none" stroke="#1D3557" stroke-width="2"/>
                
                <!-- Raquettes -->
                <rect x="20" y="55" width="45" height="70" fill="none" stroke="#1D3557" stroke-width="2"/>
                <rect x="275" y="55" width="45" height="70" fill="none" stroke="#1D3557" stroke-width="2"/>
                
                <!-- Cercles raquette -->
                <circle cx="42" cy="90" r="20" fill="none" stroke="#1D3557" stroke-width="2"/>
                <circle cx="298" cy="90" r="20" fill="none" stroke="#1D3557" stroke-width="2"/>
                
                <!-- Paniers -->
                <rect x="20" y="82" width="10" height="16" fill="#E9C46A" stroke="#333" stroke-width="1"/>
                <rect x="310" y="82" width="10" height="16" fill="#E9C46A" stroke="#333" stroke-width="1"/>
                <circle cx="25" cy="90" r="6" fill="none" stroke="#E63946" stroke-width="2"/>
                <circle cx="315" cy="90" r="6" fill="none" stroke="#E63946" stroke-width="2"/>
                
                <!-- Lignes 3 points -->
                <path d="M 65 25 Q 100 90 65 155" fill="none" stroke="#1D3557" stroke-width="2"/>
                <path d="M 275 25 Q 240 90 275 155" fill="none" stroke="#1D3557" stroke-width="2"/>
            ...
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:15px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="font-size:12px;">📐 Terrain complet</span>
                <span style="font-size:12px;">🏀 5 vs 5</span>
                <span style="font-size:12px;">⏱️ 4×5 min</span>
                <span style="font-size:12px;">📋 Règles officielles</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation de référence | Match 5 vs 5 | Terrain complet</p>
        </div>`
    },
    ...
    'Volleyball': {
        1: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                <!-- Terrain -->
                <rect x="20" y="20" width="300" height="160" fill="#F0E68C" stroke="#DAA520" stroke-width="3" rx="5"/>
                
                <!-- Filet -->
                <line x1="170" y1="20" x2="170" y2="180" stroke="#333" stroke-width="5"/>
                <line x1="170" y1="20" x2="170" y2="180" stroke="#fff" stroke-width="3" stroke-dasharray="10,5"/>
                
                <!-- Ligne des 3m -->
                <line x1="100" y1="20" x2="100" y2="180" stroke="#E63946" stroke-width="2" stroke-dasharray="8,4"/>
                <line x1="240" y1="20" x2="240" y2="180" stroke="#E63946" stroke-width="2" stroke-dasharray="8,4"/>
                <text x="100" y="190" text-anchor="middle" fill="#E63946" font-size="8">3m</text>
                <text x="240" y="190" text-anchor="middle" fill="#E63946" font-size="8">3m</text>
                
                <!-- Zones numérotées équipe gauche -->
                <text x="45" y="170" fill="#666" font-size="10" font-weight="bold">1</text>
                <text x="75" y="170" fill="#666" font-size="10" font-weight="bold">6</text>
                <text x="135" y="170" fill="#666" font-size="10" font-weight="bold">5</text>
                <text x="45" y="45" fill="#666" font-size="10" font-weight="bold">2</text>
                <text x="75" y="45" fill="#666" font-size="10" font-weight="bold">3</text>
                <text x="135" y="45" fill="#666" font-size="10" font-weight="bold">4</text>
                
                <!-- Équipe Rouge (gauche) -->
                <circle cx="55" cy="140" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="55" y="145" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">R</text>
                
                <circle cx="85" cy="100" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="85" y="105" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">P</text>
                
                <circle cx="125" cy="60" r="14" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <text x="125" y="65" text-anchor="middle" fill="#fff" font-size="9" font-weight="bold">A</text>
                
                <!-- Équipe Bleue (droite) -->
                <circle cx="215" cy="60" r="14" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="255" cy="100" r="14" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="285" cy="140" r="14" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                
                <!-- Ballon et trajectoire 3 touches -->
                <circle cx="55" cy="125" r="6" fill="#F4A261" stroke="#E76F51" stroke-width="2"/>
                
                <!-- Trajectoires -->
                <defs>
                    <marker id="arrowV1" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto">
                        <polygon points="0 0, 8 3, 0 6" fill="#457B9D"/>
                    </marker>
                </defs>
                <path d="M 60 125 Q 70 90 85 95" stroke="#457B9D" stroke-width="2" fill="none" marker-end="url(#arrowV1)"/>
                <text x="65" y="105" fill="#457B9D" font-size="8" font-weight="bold">1</text>
                
                <path d="M 92 95 Q 110 60 125 68" stroke="#457B9D" stroke-width="2" fill="none" marker-end="url(#arrowV1)"/>
                <text x="105" y="65" fill="#457B9D" font-size="8" font-weight="bold">2</text>
                
                <path d="M 132 55 Q 155 40 175 60" stroke="#E63946" stroke-width="3" fill="none" marker-end="url(#arrowV1)"/>
                <text x="155" y="45" fill="#E63946" font-size="8" font-weight="bold">3</text>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:15px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#E63946;border-radius:50%;"></span> R=Réception
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#E63946;border-radius:50%;"></span> P=Passe
                </span>
                <span style="display:flex;align-items:center;gap:5px;font-size:12px;">
                    <span style="width:14px;height:14px;background:#E63946;border-radius:50%;"></span> A=Attaque
                </span>
                <span style="font-size:12px;">1️⃣2️⃣3️⃣ = 3 touches</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation 3 vs 3 | Construction en 3 touches | Terrain 6×9m</p>
        </div>`,
        ...
        2: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <!-- Lignes des 3m -->
                <line x1="95" y1="20" x2="95" y2="180" stroke="#E63946" stroke-width="2"/>
                <line x1="245" y1="20" x2="245" y2="180" stroke="#E63946" stroke-width="2"/>
                
                <!-- Équipe Rouge -->
                <circle cx="45" cy="45" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="75" cy="45" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="45" cy="100" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                <circle cx="75" cy="100" r="11" fill="#E63946" stroke="#fff" stroke-width="2"/>
                
                <!-- Équipe Bleue -->
                <circle cx="265" cy="45" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="295" cy="45" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="265" cy="100" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                <circle cx="295" cy="100" r="11" fill="#1D3557" stroke="#fff" stroke-width="2"/>
                
                <!-- Ballon -->
                <circle cx="130" cy="150" r="7" fill="#F4A261" stroke="#E76F51" stroke-width="2"/>
                <text x="145" y="155" fill="#666" font-size="9">Service</text>
            ...
            <div style="display:flex;justify-content:center;gap:20px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                ...
                <span style="font-size:12px;">🏐 Bonus 3 touches = +1pt</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Match 4 vs 4 | Terrain 7×14m | Valoriser la construction</p>
        </div>`,
        ...
        3: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 220" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <!-- Filet -->
                <line x1="170" y1="20" x2="170" y2="180" stroke="#333" stroke-width="6"/>
                <line x1="170" y1="20" x2="170" y2="180" stroke="#fff" stroke-width="4" stroke-dasharray="12,6"/>
                
                <!-- Lignes des 3m -->
                <line x1="85" y1="20" x2="85" y2="180" stroke="#E63946" stroke-width="3"/>
                <line x1="255" y1="20" x2="255" y2="180" stroke="#E63946" stroke-width="3"/>
                
                <!-- Zones de rotation (6 positions) -->
                <text x="40" y="160" fill="#666" font-size="11" font-weight="bold">1</text>
                <text x="70" y="110" fill="#666" font-size="11" font-weight="bold">6</text>
                <text x="40" y="60" fill="#666" font-size="11" font-weight="bold">5</text>
                <text x="120" y="160" fill="#666" font-size="11" font-weight="bold">2</text>
                <text x="120" y="110" fill="#666" font-size="11" font-weight="bold">3</text>
                <text x="120" y="60" fill="#666" font-size="11" font-weight="bold">4</text>
                
                <!-- Flèche rotation -->
                <path d="M 80 85 A 20 20 0 1 1 80 115" fill="none" stroke="#2A9D8F" stroke-width="2"/>
                <text x="80" y="105" text-anchor="middle" fill="#2A9D8F" font-size="8">↻</text>
            ...
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:15px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="font-size:12px;">📐 Terrain 9×18m</span>
                <span style="font-size:12px;">🏐 6 vs 6</span>
                <span style="font-size:12px;">↻ Rotation obligatoire</span>
                <span style="font-size:12px;">📋 Sets de 15 pts</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation de référence | Match 6 vs 6 | Règles officielles</p>
        </div>`
    },
    ...
    'Course de vitesse': {
        1: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 180" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                <!-- Piste -->
                <rect x="20" y="50" width="300" height="80" fill="#E8D5B7" stroke="#8B4513" stroke-width="3" rx="5"/>
                
                <!-- Couloirs -->
                <line x1="20" y1="76" x2="320" y2="76" stroke="#fff" stroke-width="2"/>
                <line x1="20" y1="102" x2="320" y2="102" stroke="#fff" stroke-width="2"/>
                
                <!-- Zones de travail -->
                <rect x="40" y="55" width="50" height="70" fill="#4CAF50" opacity="0.3" stroke="#4CAF50" stroke-width="2"/>
                <text x="65" y="95" text-anchor="middle" fill="#2E7D32" font-size="9" font-weight="bold">POSTURE</text>
                
                <rect x="100" y="55" width="50" height="70" fill="#2196F3" opacity="0.3" stroke="#2196F3" stroke-width="2"/>
                <text x="125" y="95" text-anchor="middle" fill="#1565C0" font-size="9" font-weight="bold">RÉACTION</text>
                
                <rect x="160" y="55" width="50" height="70" fill="#FF9800" opacity="0.3" stroke="#FF9800" stroke-width="2"/>
                <text x="185" y="95" text-anchor="middle" fill="#E65100" font-size="9" font-weight="bold">APPUIS</text>
                
                <rect x="220" y="55" width="50" height="70" fill="#9C27B0" opacity="0.3" stroke="#9C27B0" stroke-width="2"/>
                <text x="245" y="95" text-anchor="middle" fill="#6A1B9A" font-size="9" font-weight="bold">FRÉQUENCE</text>
                
                <!-- Coureur -->
                <circle cx="50" cy="90" r="10" fill="#E63946" stroke="#fff" stroke-width="2"/>
                
                <!-- Flèche sens -->
                <defs>
                    <marker id="arrowC1" markerWidth="10" markerHeight="7" refX="9" refY="3.5" orient="auto">
                        <polygon points="0 0, 10 3.5, 0 7" fill="#1D3557"/>
                    </marker>
                </defs>
                <line x1="50" y1="40" x2="280" y2="40" stroke="#1D3557" stroke-width="3" marker-end="url(#arrowC1)"/>
                
                <!-- Distances -->
                <text x="65" y="145" fill="#666" font-size="9">10m</text>
                <text x="125" y="145" fill="#666" font-size="9">10m</text>
                <text x="185" y="145" fill="#666" font-size="9">10m</text>
                <text x="245" y="145" fill="#666" font-size="9">10m</text>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:15px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="font-size:12px;">🟢 Posture</span>
                <span style="font-size:12px;">🔵 Réaction</span>
                <span style="font-size:12px;">🟠 Appuis</span>
                <span style="font-size:12px;">🟣 Fréquence</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Parcours d'habiletés | 4 ateliers × 10m | Travail technique segmenté</p>
        </div>`,
        ...
        2: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 180" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <!-- Ligne de départ -->
                <line x1="40" y1="50" x2="40" y2="130" stroke="#E63946" stroke-width="4"/>
                <text x="40" y="145" text-anchor="middle" fill="#E63946" font-size="10" font-weight="bold">DÉPART</text>
                
                <!-- Starting blocks -->
                <rect x="45" y="62" width="15" height="8" fill="#333"/>
                <rect x="45" y="88" width="15" height="8" fill="#333"/>
                <rect x="45" y="114" width="15" height="8" fill="#333"/>
                
                <!-- Zone d'accélération -->
                <rect x="40" y="55" width="100" height="70" fill="#FF9800" opacity="0.2"/>
                <text x="90" y="165" text-anchor="middle" fill="#E65100" font-size="9" font-weight="bold">ACCÉLÉRATION (20m)</text>
                
                <!-- Zone maintien -->
                <rect x="140" y="55" width="100" height="70" fill="#4CAF50" opacity="0.2"/>
                <text x="190" y="165" text-anchor="middle" fill="#2E7D32" font-size="9" font-weight="bold">MAINTIEN (20m)</text>
                
                <!-- Ligne arrivée -->
                <line x1="260" y1="50" x2="260" y2="130" stroke="#E63946" stroke-width="4"/>
                <text x="260" y="145" text-anchor="middle" fill="#E63946" font-size="10" font-weight="bold">40m</text>
                
                <!-- Coureurs -->
                <circle cx="80" cy="66" r="8" fill="#1D3557"/>
                <circle cx="95" cy="92" r="8" fill="#1D3557"/>
                <circle cx="70" cy="118" r="8" fill="#1D3557"/>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:20px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="font-size:12px;">🟠 Phase d'accélération</span>
                <span style="font-size:12px;">🟢 Phase de maintien</span>
                <span style="font-size:12px;">⏱️ Chronométré</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation problème | 40m avec départ starting-blocks | Travail des phases</p>
        </div>`,
        ...
        3: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 340 180" style="width:100%;max-width:500px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                ...
                <!-- Couloirs numérotés -->
                <line x1="20" y1="70" x2="320" y2="70" stroke="#fff" stroke-width="2"/>
                <line x1="20" y1="90" x2="320" y2="90" stroke="#fff" stroke-width="2"/>
                <line x1="20" y1="110" x2="320" y2="110" stroke="#fff" stroke-width="2"/>
                <text x="15" y="63" fill="#666" font-size="8">1</text>
                <text x="15" y="83" fill="#666" font-size="8">2</text>
                <text x="15" y="103" fill="#666" font-size="8">3</text>
                <text x="15" y="123" fill="#666" font-size="8">4</text>
                
                <!-- Ligne départ -->
                <line x1="35" y1="50" x2="35" y2="130" stroke="#E63946" stroke-width="5"/>
                
                <!-- Starting blocks -->
                <rect x="40" y="56" width="12" height="6" fill="#333"/>
                <rect x="40" y="76" width="12" height="6" fill="#333"/>
                <rect x="40" y="96" width="12" height="6" fill="#333"/>
                <rect x="40" y="116" width="12" height="6" fill="#333"/>
                
                <!-- Ligne arrivée -->
                <line x1="300" y1="50" x2="300" y2="130" stroke="#E63946" stroke-width="5"/>
                <rect x="295" y="45" width="10" height="90" fill="url(#checker)" opacity="0.5"/>
                ...
                <!-- Distance -->
                <line x1="35" y1="145" x2="300" y2="145" stroke="#1D3557" stroke-width="2"/>
                <text x="167" y="160" text-anchor="middle" fill="#1D3557" font-size="12" font-weight="bold">60 MÈTRES</text>
                
                <!-- Indication officielle -->
                <rect x="115" y="15" width="110" height="25" fill="#E63946" rx="5"/>
                <text x="170" y="32" text-anchor="middle" fill="#fff" font-size="11" font-weight="bold">COURSE OFFICIELLE</text>
            </svg>
            
            <!-- Légende -->
            <div style="display:flex;justify-content:center;gap:15px;flex-wrap:wrap;margin-top:12px;padding:10px;background:#f0f0f0;border-radius:6px;">
                <span style="font-size:12px;">📏 60m (collège) / 80m (lycée)</span>
                <span style="font-size:12px;">⏱️ Chrono électronique</span>
                <span style="font-size:12px;">🏁 3 essais</span>
            </div>
            <p style="font-size:13px;color:#333;margin-top:10px;font-weight:600;">Situation de référence | Course chronométrée | Meilleur temps retenu</p>
        </div>`
    },
    // ========================================================================
    // DEFAULT (pour les autres APS)
    // ========================================================================
    'default': {
        1: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 300 150" style="width:100%;max-width:450px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                <rect x="20" y="20" width="260" height="110" fill="#E8E8E8" stroke="#666" stroke-width="3" rx="10"/>
                <text x="150" y="70" text-anchor="middle" fill="#666" font-size="14" font-weight="bold">SITUATION 1</text>
                <text x="150" y="90" text-anchor="middle" fill="#888" font-size="11">Parcours d'habiletés</text>
            </svg>
            <p style="font-size:13px;color:#555;margin-top:10px;">Travail technique analytique par ateliers</p>
        </div>`,
        
        2: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 300 150" style="width:100%;max-width:450px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                <rect x="20" y="20" width="260" height="110" fill="#E8E8E8" stroke="#666" stroke-width="3" rx="10"/>
                <text x="150" y="70" text-anchor="middle" fill="#666" font-size="14" font-weight="bold">SITUATION 2</text>
                <text x="150" y="90" text-anchor="middle" fill="#888" font-size="11">Situation problème / Match à thème</text>
            </svg>
            <p style="font-size:13px;color:#555;margin-top:10px;">Application de l'objectif en situation jouée</p>
        </div>`,
        
        3: `<div style="text-align:center;margin:20px 0;">
            <svg viewBox="0 0 300 150" style="width:100%;max-width:450px;height:auto;display:block;margin:0 auto;background:#f8f9fa;border-radius:8px;">
                <rect x="20" y="20" width="260" height="110" fill="#E8E8E8" stroke="#666" stroke-width="3" rx="10"/>
                <rect x="100" y="100" width="100" height="20" fill="#E63946" rx="4"/>
                <text x="150" y="114" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold">OFFICIEL</text>
                <text x="150" y="60" text-anchor="middle" fill="#666" font-size="14" font-weight="bold">SITUATION 3</text>
                <text x="150" y="80" text-anchor="middle" fill="#888" font-size="11">Situation de référence</text>
            </svg>
            <p style="font-size:13px;color:#555;margin-top:10px;">Évaluation en conditions réelles</p>
        </div>`
    }
    'Course de haies': {
...
const getSchema = (aps, numSit) => {
    // Vérifier si l'APS existe et si la situation existe
    if (SCHEMAS[aps] && SCHEMAS[aps][numSit]) {
        return SCHEMAS[aps][numSit];
    }
    // Sinon retourner le schéma par défaut
